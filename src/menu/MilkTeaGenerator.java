 ...
 *
 */
public class MilkTeaGenerator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(700, 508));
        setResizable(false);
        ...
        LPrice.setText("Price of Drink");
        getContentPane().add(LPrice);
        LPrice.setBounds(190, 240, 90, 20);
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/TeaBackground.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MilkTeaGenerator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
